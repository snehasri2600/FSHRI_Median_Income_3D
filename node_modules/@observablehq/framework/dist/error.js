...
${error.stack}`);
  ...
  static match(error, { message, exitCode, print } = {}) {
    ...
    if (message !== void 0 && typeof message === "string" && error.message !== message) return false;
    if (message !== void 0 && message instanceof RegExp && !message.test(error.message)) return false;
    if (exitCode !== void 0 && error.exitCode !== exitCode) return false;
    if (print !== void 0 && error.print !== print) return false;
    return true;
  }
}
export {
