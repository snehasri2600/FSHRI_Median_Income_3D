...
function parseJavaScript(input, options) {
  ...
  if (expression?.type === "ClassExpression" && expression.id) expression = null;
  if (expression?.type === "FunctionExpression" && expression.id) expression = null;
  ...
  if (exports.length) throw syntaxError("Unexpected token 'export'", exports[0], input);
